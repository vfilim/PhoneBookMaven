...
<div id="app" class="content">
    ...
    <div class="filter-container">
        <label class="mr-1">
            Введите текст:
            <input type="text" v-model="queryString" class="form-control input-sm"/>
        </label>
        <button class="btn btn-primary" @click="getFilteredContacts()">Отфильтровать</button>
        <button class="btn btn-primary" @click="clearQueryString()">Сбросить фильтр</button>
    </div>
    ...
    <table class="table table-bordered contact-table">
        ...
        <tbody>
        <tr v-cloak v-for="row in rows" :key="row.id">
            <template v-if="row.shown">
                ...
                <td>
                    <button class="btn btn-primary" @click="deleteContact(row)" type="button">Удалить</button>
                </td>
            </template>
        </tr>
        </tbody>
    ...
    <button type="button" class="btn btn-primary" @click="deleteCheckedContacts()">Удалить выбранные</button>
